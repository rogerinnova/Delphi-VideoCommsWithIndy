...
class operator TTimeSpan.GreaterThanOrEqual(const Left,
  Right: TTimeSpan): Boolean;
begin
  Result := Left.FTicks >= Right.FTicks;
end;
...
class operator TTimeSpan.Subtract(const Left: TDateTime;
  Right: TTimeSpan): TDateTime;
begin
